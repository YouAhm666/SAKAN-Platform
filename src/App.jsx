  ...
  return (
    <aside className="hidden lg:flex w-72 shrink-0 flex-col bg-[#15122A] text-[#E7E3FF]">
      <div className="flex items-center gap-3 px-6 py-6 border-b border-white/10">
        <div className="grid h-10 w-10 place-items-center rounded-lg bg-[#F5A200] text-[#15122A]">
          <KeyRound size={20} strokeWidth={2.4} />
        </div>
        <div>
          <p className="font-display text-xl leading-none tracking-tight text-white">{t.brand}</p>
          <p className="text-[11px] tracking-[0.14em] uppercase text-[#F5A200] mt-1">{t.brandSub}</p>
        </div>
      </div>
